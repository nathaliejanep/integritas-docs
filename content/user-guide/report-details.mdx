...
- **Stamp**:
  Used when validating TAR files that contain both source and JSON proof files. The system checks the stamp recorded on the blockchain against the stamp proof inside the JSON file.
