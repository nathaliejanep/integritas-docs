...
>
  <ImageZoom
    ...
    src='/docs/guide-dapp/file-details.png'
  />
</Callout>
...
- A **direct link** to the NFT is provided to view the details on the **Minima Block Explorer**.
  ...
  >
    <ImageZoom
      ...
      height={600}
      alt='Integritas MiniDapp - My Uploads / Details'
      src='/docs/guide-dapp/nft-proof.png'
    />
  </Callout>
...
>
  <ImageZoom
    ...
    height={600}
    alt='Integritas MiniDapp - My Uploads / Details'
    src='/docs/guide-dapp/block-matches.png'
  />
</Callout>
...
>
  <ImageZoom
    ...
    height={800}
    alt='Integritas MiniDapp - My Uploads / Details'
    src='/docs/guide-dapp/unique-ranges.png'
  />
</Callout>
...
>
  <ImageZoom
    ...
    height={800}
    alt='Integritas MiniDapp - My Uploads / Details'
    src='/docs/guide-dapp/hash-instances.png'
  />
</Callout>
