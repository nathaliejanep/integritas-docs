...
(a) Use "Endpoint 1", to send the file. You will receive the SHA3-256 hash of the data in the response.

(b) Use "Endpoint 2" to send the hash. You will receive a UID in the response.

(c) Use "Endpoint 3" to send the UID from the response to retrieve the proof of the time stamping.
