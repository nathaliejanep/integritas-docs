...
The system automatically detects the uploaded file type and determines whether to verify the data against the **blockchain** or the **on-chain timestamp server**.
