---
title: Stamping
description: Stamping adds trust and immutability to the data validation process by anchoring it to a specific point in time.
---
...
3. **Metadata Storage**: To enable future verification, Integritas saves essential metadata:
   ...
   - **Stamp**: The exact time your data was stamped.
