...
| -------------------------- | ------------- | ----------- | ------------------- | --------------------------------------------------------------------------------------------- |
| {REQUEST_TYPE_FILE_UPLOAD} | `file`        | `form-data` | `file`              | Validate a source file.                                                                       |
| {REQUEST_TYPE_FILE_UPLOAD} | `file`        | `form-data` | `file`              | Validate a `.tar` file. The `.tar` file should contain the source file and a JSON proof file. |
| {REQUEST_TYPE_FILE_UPLOAD} | `file + file` | `form-data` | `file`, `jsonproof` | Validate a source file with a JSON proof file.                                                |
