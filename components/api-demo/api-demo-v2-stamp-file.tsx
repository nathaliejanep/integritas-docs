...
import { API_BASE_URL, ENDPOINT_V2_TIMESTAMP_POST } from '@/lib/constants';

export function ApiDemoV2StampFile() {
  const {
    apiKey,
    setApiKey,
    requestId,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`${API_BASE_URL}${ENDPOINT_V2_TIMESTAMP_POST}`, {
        method: 'POST',
        headers,
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            placeholder='a1b2c3d4e5f67890abcdef1234567890abcdef1234567890abcdef1234567891'
